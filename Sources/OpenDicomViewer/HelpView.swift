            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    helpSection("Overview") {
                        Text("Smart DICOM Viewer is a native macOS DICOM image viewer built for radiology workflows. It supports multi-panel layouts, MPR (multiplanar reconstruction), window/level adjustment, measurement annotations, and cross-reference lines.")
                    }
